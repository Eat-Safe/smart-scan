...
function InfoBox() {
    ...
    return (
        <div className='collapsible-container'>
            ...
            <strong>- Center Positioning:</strong> To achieve the best results, ensure that the food label is positioned at the center of the camera frame. This facilitates clear and accurate scanning. 
